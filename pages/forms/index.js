    ...
    <>
      <main>
        ...
        <form action="." method="post">
          <p>Branding Profile</p>
          <label>Name of Company:</label>
          <input type="text" name="company" id="company" />
          <label>Company tag line or slogan:</label>
          <input
            type="text"
            name="slogan"
            id="slogan"
          ...
          <label>Where will you use your new identity?</label>
          <input
            type="text"
            name="usage"
            id="usage"
          ...
          <span class="radio-button">
            ...
            <label class="radio">
              <input type="radio" name="has_site" value="yes" class="parent" />
              Yes
            </label>
            <label class="radio">
          ...
          <label>What is the URL (web address)?</label>
          ...
          <span class="radio-button">
            ...
            <label class="radio">
              <input type="radio" name="keep_site" value="new" class="parent" />
          ...
          <textarea
            ...
            class="child"
          ></textarea>
          <label>What type of look are you trying to achieve?</label>
          ...
          <label>
            Please list at least 3 URLs of high quality sites that you like the
            look of:
          </label>
          <span class="hint">
            These do not have to be sites whose business is similar to yours. It
            aids us in determining what your design style is. Please consider
          ...
          <span class="radio-button">
            ...
            <label class="radio">
              <input type="radio" name="copy_help" value="yes" class="child" />
              Yes
            </label>
            <label class="radio">
          ...
          <label>How do you normally obtain clients?</label>
          <input
            type="text"
            name="clientele"
            id="clientele"
        ...
        <Link href="/forms/structured"><a>Next Section</a></Link>
      </main>
    </>
  );
}
