        ...
        <form action="." method="post" onSubmit={submitForm}>
          <fieldset className="branding">
            ...
            <input
              ...
              aria-required="true"
            />
            <label htmlFor="slogan">Company tag line or slogan:</label>
            <input
              type="text"
              name="slogan"
              id="slogan"
            ...
            <input
              ...
              aria-required="true"
            />
            <label htmlFor="identity-accomplish">
            ...
            ></textarea>
            <label htmlFor="goals">What are your long term goals?</label>
            ...
            <label htmlFor="audience-current">
            ...
            <label htmlFor="competitor-identity">
            ...
            ></textarea>
            <label htmlFor="competitor-apart">
              What sets you apart from your competition?
            </label>
            <textarea id="competitor-apart" name="competitor-apart"></textarea>
            <label htmlFor="usage">Where will you use your new identity?</label>
            <input
              type="text"
              name="usage"
              id="usage"
          ...
          <fieldset className="website">
            ...
            <label htmlFor="url">What is the URL (web address)?</label>
          ...
          <fieldset className="marketing">
            ...
            <label htmlFor="clientele">How do you normally obtain clients?</label>
            <input
              type="text"
              name="clientele"
              id="clientele"
